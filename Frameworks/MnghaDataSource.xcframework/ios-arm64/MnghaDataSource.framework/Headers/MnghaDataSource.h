 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getPreventiveTestListWithCompletionHandler:(void (^)(MDSResponse<MDSKotlinArray<MDSPreventive *> *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getPreventiveTestList(completionHandler:)")));
...
- (instancetype)initWithToken:(NSString * _Nullable)token lastTwoDigits:(NSString * _Nullable)lastTwoDigits success:(BOOL)success errorMessage:(NSString * _Nullable)errorMessage __attribute__((swift_name("init(token:lastTwoDigits:success:errorMessage:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) MDSAuthenticationResponseCompanion *companion __attribute__((swift_name("companion")));
- (MDSAuthenticationResponse *)doCopyToken:(NSString * _Nullable)token lastTwoDigits:(NSString * _Nullable)lastTwoDigits success:(BOOL)success errorMessage:(NSString * _Nullable)errorMessage __attribute__((swift_name("doCopy(token:lastTwoDigits:success:errorMessage:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithExist:(NSString * _Nullable)exist sso:(NSString * _Nullable)sso message:(NSString * _Nullable)message token:(NSString * _Nullable)token __attribute__((swift_name("init(exist:sso:message:token:)"))) __attribute__((objc_designated_initializer));
...
- (MDSCheckNationalIdResponse *)doCopyExist:(NSString * _Nullable)exist sso:(NSString * _Nullable)sso message:(NSString * _Nullable)message token:(NSString * _Nullable)token __attribute__((swift_name("doCopy(exist:sso:message:token:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
- (instancetype)initWithPactTypeCode:(NSString * _Nullable)pactTypeCode englishMessage:(NSString * _Nullable)englishMessage arabicMessage:(NSString * _Nullable)arabicMessage ord_CD:(NSString * _Nullable)ord_CD ord_DT:(NSString * _Nullable)ord_DT ord_NM:(NSString * _Nullable)ord_NM tkmd_GUID_AMD_DSG_CNTE:(NSString * _Nullable)tkmd_GUID_AMD_DSG_CNTE lcl_AMD_PRD_TQTY_CNTE:(NSString * _Nullable)lcl_AMD_PRD_TQTY_CNTE ord_DURATION:(NSString * _Nullable)ord_DURATION amd_DSG_CNTE:(NSString * _Nullable)amd_DSG_CNTE th1_USG_EXPL:(NSString * _Nullable)th1_USG_EXPL hsp_TP_CD:(NSString * _Nullable)hsp_TP_CD th3_USG_EXPL:(NSString * _Nullable)th3_USG_EXPL ams_ORD_STS_CD:(NSString * _Nullable)ams_ORD_STS_CD lcl_HSP_NM:(NSString * _Nullable)lcl_HSP_NM rfl_RM_NOTM:(NSString * _Nullable)rfl_RM_NOTM eng_MDPR_NM:(NSString * _Nullable)eng_MDPR_NM lcl_AMD_DSG_CNTE:(NSString * _Nullable)lcl_AMD_DSG_CNTE pt_NO:(NSString * _Nullable)pt_NO hsp_NM:(NSString * _Nullable)hsp_NM pt_NM:(NSString * _Nullable)pt_NM tkmd_GUID_AMD_PRD_TQTY_CNTE:(NSString * _Nullable)tkmd_GUID_AMD_PRD_TQTY_CNTE ord_ID:(NSString * _Nullable)ord_ID date_HIJRI:(NSString * _Nullable)date_HIJRI items:(MDSKotlinArray<MDSPrescriptionResult *> * _Nullable)items __attribute__((swift_name("init(pactTypeCode:englishMessage:arabicMessage:ord_CD:ord_DT:ord_NM:tkmd_GUID_AMD_DSG_CNTE:lcl_AMD_PRD_TQTY_CNTE:ord_DURATION:amd_DSG_CNTE:th1_USG_EXPL:hsp_TP_CD:th3_USG_EXPL:ams_ORD_STS_CD:lcl_HSP_NM:rfl_RM_NOTM:eng_MDPR_NM:lcl_AMD_DSG_CNTE:pt_NO:hsp_NM:pt_NM:tkmd_GUID_AMD_PRD_TQTY_CNTE:ord_ID:date_HIJRI:items:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) MDSPrescriptionResultCompanion *companion __attribute__((swift_name("companion")));
- (MDSPrescriptionResult *)doCopyPactTypeCode:(NSString * _Nullable)pactTypeCode englishMessage:(NSString * _Nullable)englishMessage arabicMessage:(NSString * _Nullable)arabicMessage ord_CD:(NSString * _Nullable)ord_CD ord_DT:(NSString * _Nullable)ord_DT ord_NM:(NSString * _Nullable)ord_NM tkmd_GUID_AMD_DSG_CNTE:(NSString * _Nullable)tkmd_GUID_AMD_DSG_CNTE lcl_AMD_PRD_TQTY_CNTE:(NSString * _Nullable)lcl_AMD_PRD_TQTY_CNTE ord_DURATION:(NSString * _Nullable)ord_DURATION amd_DSG_CNTE:(NSString * _Nullable)amd_DSG_CNTE th1_USG_EXPL:(NSString * _Nullable)th1_USG_EXPL hsp_TP_CD:(NSString * _Nullable)hsp_TP_CD th3_USG_EXPL:(NSString * _Nullable)th3_USG_EXPL ams_ORD_STS_CD:(NSString * _Nullable)ams_ORD_STS_CD lcl_HSP_NM:(NSString * _Nullable)lcl_HSP_NM rfl_RM_NOTM:(NSString * _Nullable)rfl_RM_NOTM eng_MDPR_NM:(NSString * _Nullable)eng_MDPR_NM lcl_AMD_DSG_CNTE:(NSString * _Nullable)lcl_AMD_DSG_CNTE pt_NO:(NSString * _Nullable)pt_NO hsp_NM:(NSString * _Nullable)hsp_NM pt_NM:(NSString * _Nullable)pt_NM tkmd_GUID_AMD_PRD_TQTY_CNTE:(NSString * _Nullable)tkmd_GUID_AMD_PRD_TQTY_CNTE ord_ID:(NSString * _Nullable)ord_ID date_HIJRI:(NSString * _Nullable)date_HIJRI items:(MDSKotlinArray<MDSPrescriptionResult *> * _Nullable)items __attribute__((swift_name("doCopy(pactTypeCode:englishMessage:arabicMessage:ord_CD:ord_DT:ord_NM:tkmd_GUID_AMD_DSG_CNTE:lcl_AMD_PRD_TQTY_CNTE:ord_DURATION:amd_DSG_CNTE:th1_USG_EXPL:hsp_TP_CD:th3_USG_EXPL:ams_ORD_STS_CD:lcl_HSP_NM:rfl_RM_NOTM:eng_MDPR_NM:lcl_AMD_DSG_CNTE:pt_NO:hsp_NM:pt_NM:tkmd_GUID_AMD_PRD_TQTY_CNTE:ord_ID:date_HIJRI:items:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
*/
@property (readonly) NSString * _Nullable ord_ID __attribute__((swift_name("ord_ID")));
...
*/
@property (readonly) NSString * _Nullable rfl_RM_NOTM __attribute__((swift_name("rfl_RM_NOTM")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Preventive")))
@interface MDSPreventive : MDSBase
...
@property (class, readonly, getter=companion) MDSPreventiveCompanion *companion __attribute__((swift_name("companion")));
- (MDSPreventive *)doCopyEnglishName:(NSString * _Nullable)englishName arabicName:(NSString * _Nullable)arabicName __attribute__((swift_name("doCopy(englishName:arabicName:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Preventive.Companion")))
@interface MDSPreventiveCompanion : MDSBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) MDSPreventiveCompanion *shared __attribute__((swift_name("shared")));
- (id<MDSKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
